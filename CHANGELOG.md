...
- Updated dependencies: `@deno/loader`, `std`, `sass`, `decap`, `html-validate`, `remove-markdown`, `satori`, `terser`, `unocss`, `lightningcss`, `purgecss`, `katex`, `autoprefixer` and some icons.
