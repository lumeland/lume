...
- Updated dependencies: `katex`, `ai_robots`, `terser`, `sass`, `html-validate`, `postcss`, `postcss-import`, `autoprefixer`, `highlight.js`, `zip-js`, `satori`, `unocss`, `svgo`, `remove-markdown`, `sharp`, `decap-cms`, `partytown`, `markdown-it`, `magic-string`, `katex` and icons.
