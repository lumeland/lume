...
### Fixed
- The `hreflang` links generated by the `multilanguage` plugin must be absolute.
- The `hreflang` links generated by the `multilanguage` plugin must include the current page.
- Move the `nunjucks` dependency to `npm:` import.
- Updated dependencies: `sass`, `deno_dom`.
