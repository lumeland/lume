import katex, { type KatexOptions as BaseOptions } from "npm:katex@0.16.38";
import "npm:katex@0.16.38/contrib/mhchem";

export const assetsUrl = "https://cdn.jsdelivr.net/npm/katex@0.16.38/dist";
