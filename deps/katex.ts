import katex, { type KatexOptions as BaseOptions } from "npm:katex@0.17.0";
import "npm:katex@0.17.0/contrib/mhchem";

export const assetsUrl = "https://cdn.jsdelivr.net/npm/katex@0.17.0/dist";
