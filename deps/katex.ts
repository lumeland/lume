import katex, { type KatexOptions as BaseOptions } from "npm:katex@0.18.4";
import "npm:katex@0.18.4/contrib/mhchem";

export const assetsUrl = "https://cdn.jsdelivr.net/npm/katex@0.18.4/dist";
