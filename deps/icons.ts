...
export const catalogs: Catalog[] = [
  ...
  },
  {
    // https://lucide.dev/
    id: "lucide",
    src: "https://cdn.jsdelivr.net/npm/lucide-static@1.31.0/icons/{name}.svg",
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-100",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-100@0.45.10/{variant}/{name}.svg",
  ...
  },
  {
    ...
    id: "material-200",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-200@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-300",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-300@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-400",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-400@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-500",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-600",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-600@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
    // https://fonts.google.com/icons?icon.set=Material+Symbols
    id: "material-700",
    src:
      "https://cdn.jsdelivr.net/npm/@material-symbols/svg-700@0.45.10/{variant}/{name}.svg",
    variants: ["outlined", "rounded", "sharp"],
  },
  {
  ...
  },
  {
    ...
    id: "simpleicons",
    src: "https://cdn.jsdelivr.net/npm/simple-icons@16.28.0/icons/{name}.svg",
  },
  {
  ...
  },
  {
    ...
    id: "myna",
    src:
      "https://cdn.jsdelivr.net/npm/@mynaui/icons@0.4.11/{variant}/{name}.svg",
    variants: [
  ...
  },
  {
    ...
    id: "iconoir",
    src:
      "https://cdn.jsdelivr.net/npm/iconoir@7.11.1/icons/{variant}/{name}.svg",
  ...
  },
  {
    ...
    name: capitalize,
    src:
      "https://cdn.jsdelivr.net/npm/sargam-icons@1.6.7/Icons/{variant}/si_{name}.svg",
    variants: [
  ...
  },
  {
    ...
    id: "ant",
    src:
      "https://cdn.jsdelivr.net/npm/@ant-design/icons-svg@4.5.0/inline-namespaced-svg/{variant}/{name}.svg",
  ...
  },
  {
    ...
    id: "fluent",
    src:
      "https://cdn.jsdelivr.net/npm/@fluentui/svg-icons@1.1.335/icons/{name}_{variant}.svg",
    variants: [
  ...
  },
  {
    ...
    id: "octicons",
    src:
      "https://cdn.jsdelivr.net/npm/@primer/octicons@19.33.0/build/svg/{name}-{variant}.svg",
  ...
  },
  {
    ...
    id: "openmoji",
    src:
      "https://cdn.jsdelivr.net/npm/openmoji@17.0.0/{variant}/svg/{name}.svg",
...
export const mingcute: Record<2 | 3, Catalog> = {
  3: {
    id: "mingcute",
    src:
      "https://cdn.jsdelivr.net/npm/@mingcute/svg@3.0.2/core-{variant}/{name}.svg",
