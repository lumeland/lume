import "npm:@lumeland/ssx@0.1.2-beta.3/jsx-runtime";
export { renderComponent } from "npm:@lumeland/ssx@0.1.2-beta.3/jsx-runtime";
export const specifier = "npm:@lumeland/ssx@0.1.2-beta.3";
