...
import transformerVariantGroupImport from "npm:@unocss/transformer-variant-group@0.58.0";
import transformerDirectivesImport from "npm:@unocss/transformer-directives@0.58.0";
...
export {
  ...
  type UserConfig,
} from "npm:@unocss/core@0.58.0";
export { presetUno } from "npm:@unocss/preset-uno@0.58.0";
...
export const resetUrl = "https://unpkg.com/@unocss/reset@0.58.0";
